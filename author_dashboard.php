...
<body>
	<div class="main_div" style="margin-top:-23px;">
	<?php
...
?>
	<div class="signup_form">
		<div class="upload_docs_form">
			<h2>Please Choose a file</h2><br><br>
			<form method="post" enctype="multipart/form-data" action="author_dashboard.php">
				<label for="doc">Please Choose a File : </label><br><br>
				<input type="file"  id="doc" name="doc" class="btn-orange"><br><br>				
				<label>Please select an editor : </label><br><br>
				<select name="editors" style="width: 100%;height: 30px;">
					<?php 
						$select_editors_sql = "SELECT * FROM `editors`";
						$select_editors_result = mysqli_query($conn,$select_editors_sql);
						while($row=mysqli_fetch_assoc($select_editors_result))
						{
							$id = $row['id'];
			...
			<input type="submit" class="btn-green" name="upload"><br><br>
			</form>	
		</div>
